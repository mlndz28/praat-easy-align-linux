# EasyAlign for Praat
# Copyright @2006 Jean-Philippe Goldman, University of Geneva, Switzerland
#
...
Add menu command... "Objects" "Control" "2. Phonetization..." "EasyAlign" 1 phonetize_orthotier2.praat
...
Add menu command... "Objects" "Control" "Check phone symbols" "EasyAlign" 1 checkPhonesInTiers.praat
Add menu command... "Objects" "Control" "Syllabify" "EasyAlign" 1 syllabify2.praat
#Add menu command... "Objects" "Control" "Check valid phones,syll,words" "EasyAlign" 1 checks.praat
#Add menu command... "Objects" "Control" "Check durations" "EasyAlign" 1 check_phone_durations.praat
Add menu command... "Objects" "Control" "-" "EasyAlign" 1
